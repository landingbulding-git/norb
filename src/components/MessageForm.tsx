        ...
        {step === 'message' && (
          ...
          >
            <form onSubmit={handleMessageSubmit} className="relative">
              <div className="relative flex flex-col md:flex-row items-stretch gap-2 bg-zinc-900 border border-zinc-800 rounded-xl p-2 focus-within:border-orange-600 focus-within:ring-1 focus-within:ring-orange-600 transition-all">
                <input
                  id="message-input"
                  type="text"
